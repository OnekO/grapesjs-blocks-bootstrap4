...
export default grapesjs.plugins.add('grapesjs-blocks-bootstrap4', (editor, opts = {}) => {
  ...
  const defaultText = {
      ...
      badge: 'Badge',
      card: 'Card',
      cardImageTop: 'Card image top',
      cardHeader: 'Card header',
      cardImage: 'Card image',
      cardImageOverlay: 'Card image overlay',
      cardBody: 'Card body',
      cardFooter: 'Card footer',
      cardImageBottom: 'Card image bottom',
      cardContainer: 'Card container',
      header: 'Header',
      oneLargest: 'One (largest)',
      two: 'Two',
      three: 'Three',
      four: 'Four',
      five: 'Five',
      sixSmallest: 'Six (smallest)',
      fourSmallest: 'Four (smallest)',
      paragraph: 'Paragraph',
      button: 'Button',
      inline: 'Inline',
      block: 'Block',
      ...
      modalImportLabel: '',
      cleanCanvas: 'Are you sure to clean the canvas?',
  };
